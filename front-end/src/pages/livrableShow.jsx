                    ...
                    <div className="col-10 col-md-6 border rounded p-3">
                        ...
                        <div className="d-flex justify-content-between">
                            <div>
                                ...
                                {/*seulement l'encardrant peut voir ce formulaire*/}
                                <form action="" method="post" className="input-group">
                                    <input type="text" name="note_finale" id="" className="form-control" placeholder="noter l'avencement"/>
                                    <input type="submit" value="Noter" className="btn text-light" style={{'backgroundColor' : '#2bae68'}} />
                                </form>
                                {/*retourner à la page de liste*/}
                                <Link to={'/livrablesIndex'} className="text-light r btn mt-3">
